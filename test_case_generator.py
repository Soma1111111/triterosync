#this is used to create random correct testcases for the project(test case generator)
...
# Run it
generate_testcase_from_csv("student_course_grades.csv", "example_testcase2.in", num_lines=20)
